...
},
{
    ...
    year: "1995-1998",
    type: "OVA / Serie",
    duration: "2 OVAs (1995-1996) + 26 episodios TV (1998)",
    studio: "Zero-G Room (OVA) / Studio Deen (TV)",
    director: "Hiroshi Negishi (OVA 1) / Yasuhiro Kuroda (OVA 2) / Tsukasa Sunaga (TV)",
    ...
    description: "En el reino de Kuruda, Elle Ragu, la 59ª Sevaar, entrena a su hermano adoptivo Gau Ban en el arte marcial definitivo: el Shadow Skill. La franquicia incluye tres OVAs (1995-2003) de tono serio y una serie de TV de 26 episodios (1998) con un enfoque más ligero y cómico [citation:6][citation:11].",
    plot: "Elle Ragu y Gau Ban viajan anualmente a la tumba de los padres de Gau para mostrar su progreso como guerrero [citation:1]. Gau entrena bajo la tutela de Elle para convertirse en un Sevaar, pero su camino está lleno de enemigos que buscan eliminarlos. La serie de TV expande la historia con un tono más ligero, donde Elle lidia con sus deudas y su adicción al alcohol, mientras Gau se entrena para algún día poder derrotarla [citation:5][citation:6].",
    analysis: "Shadow Skill es un clásico de las artes marciales que se divide en tres producciones. La primera OVA (1995) es un episodio de 45 min que presenta la historia principal [citation:1]. La segunda OVA (1996) consta de 3 episodios de 24 min que profundizan en el pasado de los personajes y las técnicas del Shadow Skill [citation:4][citation:5]. La serie de TV (1998) de 26 episodios es un remake con un enfoque más cómico, similar a Slayers, y una animación de calidad ligeramente inferior pero aún sólida [citation:5][citation:6]. Una tercera OVA (2003), 'Secret of the Kurudan Style', fue lanzada años después con CGI de calidad cuestionable [citation:3][citation:11].",
    forgotten: "A pesar de ser popular en los 90, Shadow Skill nunca alcanzó el estatus de culto de otras series de artes marciales. Las OVAs originales son hoy una rareza que solo los coleccionistas recuerdan, y la serie de TV de 1998 pasó desapercibida para muchos [citation:11]. Sin embargo, la franquicia sigue siendo un ejemplo interesante de cómo una misma historia puede ser contada con tonos muy diferentes.",
    reel: "",
    related: [8, 11, 17]
},
{
