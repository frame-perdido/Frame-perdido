// ============================================================
// AGE VERIFICATION - Versión segura (no bloquea otros scripts)
// ============================================================
(function() {
    'use strict';
    ...
    function init() {
        ...
        styles.textContent = `
            ...
            .age-box .age-icon { font-size: 4rem; margin-bottom: 12px; }
            .age-box h2 {
            ...
            .age-box .age-warning strong { color: #fbbf24; }
            .age-buttons {
                display: flex;
                gap: 12px;
                justify-content: center;
        ...
        overlay.innerHTML = `
            <div class="age-box">
                ...
                <div class="age-buttons">
                    <button class="age-btn age-btn-yes" id="age-btn-yes">✔️ Soy mayor de edad</button>
                    <button class="age-btn age-btn-no" id="age-btn-no">✖️ Salir</button>
                </div>
            </div>
        `;

        // Agregar al body (sin borrar nada)
        document.body.appendChild(overlay);

        // Event listeners (NO onclick inline)
        document.getElementById('age-btn-yes').addEventListener('click', function() {
            overlay.classList.add('hidden');
            localStorage.setItem(STORAGE_KEY, 'true');
        });

        document.getElementById('age-btn-no').addEventListener('click', function() {
